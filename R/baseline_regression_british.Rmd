...
extracted_geno_data_british_gwas <- readRDS(file = "~/Documents/UKBB/british_gwas/dat_LDL_British_pheotype_genotype_british_gwas_all_snps_p0005.rds")
...
```{r}
X_train <- readRDS("~/Documents/UKBB/british_gwas/X_british_train.rds")
X_test <- readRDS("~/Documents/UKBB/british_gwas/X_british_test.rds")
y_train <- readRDS("~/Documents/UKBB/british_gwas/y_british_train.rds")
y_test <- readRDS("~/Documents/UKBB/british_gwas/y_british_test.rds")
